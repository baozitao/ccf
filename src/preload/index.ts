...
export interface CluiAPI {
  ...
  // ─── Window management ───
  resizeHeight(height: number, growOnly?: boolean, width?: number): Promise<void>
...
const api: CluiAPI = {
  ...
  // ─── Window management ───
  resizeHeight: (height, growOnly, width) => ipcRenderer.invoke(IPC.RESIZE_HEIGHT, height, growOnly, width),
